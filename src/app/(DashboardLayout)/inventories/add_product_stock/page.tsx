...
export default function CreatePage() {
  ...
  const postAPI = async () => {
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/inventories/by_warehouse/${selectedWarehouseId}/add_product_stock`, {
        method: 'POST',
  ...
  return (
    <PageContainer title="Inventory Stock - Add Page" description="this is Inventory Stock - Add Page">
      <Box>
